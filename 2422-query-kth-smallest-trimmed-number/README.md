<h2><a href="https://leetcode.com/problems/query-kth-smallest-trimmed-number/?envType=problem-list-v2&envId=sorting">2422. Query Kth Smallest Trimmed Number</a></h2><h3>Medium</h3><hr><p>You are given a <strong>0-indexed</strong> array of strings <code>nums</code>, where each string is of <strong>equal length</strong> and consists of only digits.</p>
